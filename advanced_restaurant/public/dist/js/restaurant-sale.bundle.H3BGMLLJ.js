(() => {
  ...
  // ../advanced_restaurant/advanced_restaurant/advanced_restaurant/page/restaurant_sale/sale_pos_item_selector.js
  var import_onscan = __toESM(require_onscan());
  restaurant.Sale.ItemSelector = class {
    ...
    get_items({ start = 0, page_length = 40, search_term = "" }) {
      ...
      return frappe.call({
        method: "advanced_restaurant.advanced_restaurant.page.restaurant_sale.sale.get_items",
        freeze: true,
    ...
    get_item_html(item) {
      ...
      return `<div class="item-wrapper item-details-wrapper"
    ...
    bind_events() {
      ...
      this.$component.on("click", ".item-wrapper", function() {
        console.log("triggered click here");
        const $item = $(this);
    ...
    add_filtered_item_to_cart() {
      console.log("adding filtered to cart");
    }
  ...
  // ../advanced_restaurant/advanced_restaurant/advanced_restaurant/page/restaurant_sale/sale_pos_item_cart.js
  restaurant.Sale.ItemCart = class {
    constructor({ wrapper, events, settings, table_no }) {
      this.wrapper = wrapper;
      this.item_cart_events = events;
      this.customer_info = void 0;
      this.hide_images = settings.hide_images;
      this.allowed_customer_groups = settings.customer_groups;
      this.allow_rate_change = settings.allow_rate_change;
      this.allow_discount_change = settings.allow_discount_change;
      this.selected_table = table_no;
      this.init_component();
    }
    init_component() {
      this.prepare_dom();
    ...
    init_customer_selector() {
      this.$component.append(
        `<div class="customer-section"></div>
			<div class="alert alert-success mt-2 mb-0 d-flex flex-row align-center justify-between">
			 <h5>Table: ${this.selected_table}</h5>
			 <button class="btn btn-sm btn-primary" id="change_table_btn">Change table</button>
			</div>
			`
      );
    ...
    reset_customer_selector() {
      const frm = this.item_cart_events.get_frm();
    ...
    make_cart_numpad() {
      ...
      this.number_pad = new restaurant.Sale.NumberPad({
    ...
    bind_events() {
      ...
      $("button#change_table_btn").click(function() {
        me.item_cart_events.change_table();
      });
      ...
      this.$cart_items_wrapper.on("click", ".cart-item-wrapper", function() {
        ...
        me.item_cart_events.cart_item_clicked({ name: item_row_name });
        this.numpad_value = "";
      });
      this.$component.on("click", ".checkout-btn", async function() {
        if ($(this).attr("style").indexOf("--blue-500") == -1)
          return;
        await me.item_cart_events.checkout();
        me.toggle_checkout_btn(false);
        me.allow_discount_change && me.$add_discount_elem.removeClass("d-none");
      });
      this.$totals_section.on("click", ".edit-cart-btn", () => {
        this.item_cart_events.edit_cart();
    ...
    make_customer_selector() {
      ...
      this.customer_field = frappe.ui.form.make_control({
        df: {
          ...
          onchange: function() {
            if (this.value) {
              const frm = me.item_cart_events.get_frm();
              frappe.dom.freeze();
              frappe.model.set_value(frm.doc.doctype, frm.doc.name, "customer", this.value);
              frm.script_manager.trigger("customer", frm.doc.doctype, frm.doc.name).then(() => {
                frappe.run_serially([
                  () => me.fetch_customer_details(this.value),
                  () => me.item_cart_events.customer_details_updated(me.customer_info),
    ...
    update_totals_section(frm) {
      if (!frm)
        frm = this.item_cart_events.get_frm();
    ...
    render_net_total(value) {
      const currency = this.item_cart_events.get_frm().doc.currency;
    ...
    get_item_from_frm(item) {
      const doc = this.item_cart_events.get_frm().doc;
    ...
    on_numpad_event($btn) {
      ...
      if (action_is_field_edit) {
        ...
        this.item_cart_events.numpad_event(void 0, current_action);
        return;
      ...
      this.item_cart_events.numpad_event(this.numpad_value, this.prev_action);
    }
    ...
    load_invoice() {
      ...
      this.fetch_customer_details(frm.doc.customer).then(() => {
        this.item_cart_events.customer_details_updated(this.customer_info);
        this.update_customer_section();
      });
      this.$cart_items_wrapper.html("");
      if (frm.doc.items.length) {
  ...
  // ../advanced_restaurant/advanced_restaurant/advanced_restaurant/page/restaurant_sale/sale_pos_item_details.js
  restaurant.Sale.ItemDetails = class {
...
`);
  ...
  // ../advanced_restaurant/advanced_restaurant/advanced_restaurant/page/restaurant_sale/sale_number_pad.js
  restaurant.Sale.NumberPad = class {
  ...
  // ../advanced_restaurant/advanced_restaurant/advanced_restaurant/page/restaurant_sale/sale_pos_payment.js
  restaurant.Sale.Payment = class {
  ...
  // ../advanced_restaurant/advanced_restaurant/advanced_restaurant/page/restaurant_sale/sale_past_order_list.js
  restaurant.Sale.PastOrderList = class {
...
Return`,
  ...
  // ../advanced_restaurant/advanced_restaurant/advanced_restaurant/page/restaurant_sale/sale_past_order_summary.js
  restaurant.Sale.PastOrderSummary = class {
    constructor({ wrapper, events }) {
      this.wrapper = wrapper;
      this.events = events;
      this.init_component();
  ...
  // ../advanced_restaurant/advanced_restaurant/advanced_restaurant/page/restaurant_sale/sale_pos.js
  restaurant.Sale.PosSale = class {
    constructor({ wrapper, table, opening_entry, page, sale_events }) {
      this.wrapper = wrapper;
      this.page = page;
      this.table_selected = table;
      this.opening_entry = opening_entry;
      this.sale_ev = sale_events;
      $(this.wrapper).empty();
      this.start_open_entry();
    }
    open_entry_handler() {
      return frappe.call("advanced_restaurant.advanced_restaurant.page.restaurant_sale.sale.check_opening_entry", { "name": this.opening_entry.name });
    }
    start_open_entry() {
      this.open_entry_handler().then((r) => {
        if (r.message.length) {
    ...
    init_item_selector() {
      this.item_selector = new restaurant.Sale.ItemSelector({
    ...
    init_item_cart() {
      this.cart = new restaurant.Sale.ItemCart({
        wrapper: this.$components_wrapper,
        settings: this.settings,
        table_no: this.table_selected,
        events: {
          get_frm: () => this.frm,
          change_table: () => this.sale_ev.change_table(),
    ...
    init_item_details() {
      this.item_details = new restaurant.Sale.ItemDetails({
        wrapper: this.$components_wrapper,
        settings: this.settings,
        events: {
          get_frm: () => this.frm,
...
`);
    ...
    init_payments() {
      this.payment = new restaurant.Sale.Payment({
        wrapper: this.$components_wrapper,
        events: {
          get_frm: () => this.frm || {},
    ...
    init_recent_order_list() {
      this.recent_order_list = new restaurant.Sale.PastOrderList({
        wrapper: this.$components_wrapper,
        events: {
    ...
    init_order_summary() {
      this.order_summary = new restaurant.Sale.PastOrderSummary({
        wrapper: this.$components_wrapper,
        events: {
          get_frm: () => this.frm,
          process_return: (name) => {
...
`).length || 0;
  ...
  // ../advanced_restaurant/advanced_restaurant/advanced_restaurant/page/restaurant_sale/sale_table_selection.js
  restaurant.Sale.TableSelection = class {
    ...
    bind_events() {
      const me = this;
      this.$tableselection_component.on("click", "button.select_table", function(event2) {
      ...
      this.$close_shift_btn.click(function(event2) {
        frappe.utils.play_sound("click");
        frappe.confirm(
  ...
  // ../advanced_restaurant/advanced_restaurant/advanced_restaurant/page/restaurant_sale/sale_location_selection.js
  restaurant.Sale.LocationSelection = class {
    ...
    bind_events() {
      const me = this;
      this.$newshiftbtn_component.click(function(event2) {
        frappe.utils.play_sound("click");
  ...
  // ../advanced_restaurant/advanced_restaurant/advanced_restaurant/page/restaurant_sale/sale_pos_shift_opening.js
  restaurant.Sale.PosShiftOpening = class {
    ...
    bind_events() {
      ...
      this.$change_location_btn_component.click(function(event2) {
        frappe.utils.play_sound("click");
        frappe.confirm(
      ...
      this.$exisingshift_table.on("click", "button.open_shift", function(event2) {
  ...
  // ../advanced_restaurant/advanced_restaurant/advanced_restaurant/page/restaurant_sale/sale_shift_details.js
  restaurant.Sale.PosShiftOpeningDetails = class {
    ...
    init_close() {
      frappe.utils.play_sound("click");
      frappe.confirm(
        "This will also close any open waiter pos shift. Would you like to continue?",
        () => {
          frappe.utils.play_sound("submit");
          frappe.call({
    ...
    bind_events() {
      const me = this;
      this.$open_waiter_pos_btn.click(function(event2) {
        frappe.utils.play_sound("click");
        frappe.confirm(
          "Are you sure you want to open waiter pos?",
          () => {
            frappe.utils.play_sound("submit");
            frappe.call({
  ...
  // ../advanced_restaurant/advanced_restaurant/advanced_restaurant/page/restaurant_sale/sale_loading.js
  ...
  // ../advanced_restaurant/advanced_restaurant/advanced_restaurant/page/restaurant_sale/sale_controller.js
  restaurant.Sale.Controller = class {
    constructor(wrapper) {
      __publicField(this, "opening_shift_token", "opening_shift_token");
      __publicField(this, "opening_waiter_shift_token", "opening_waiter_shift_token");
      __publicField(this, "selected_location_token", "selected_location_token");
      __publicField(this, "selected_table_token", "selected_table_token");
...
//# sourceMappingURL=restaurant-sale.bundle.H3BGMLLJ.js.map
